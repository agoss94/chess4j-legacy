...
public final class PawnMove implements Move {
     ...
     * is allowed to move. A white pawn can move up the board and a black pawn can
     * only move down.
     *
    ...
    public static Move perform(Tile start, Tile end, Board board) {
        return isValidMoveForward(start, end, board) || isValidCapture(start, end, board) ? new PawnMove(start, end, board) : null;
    }
