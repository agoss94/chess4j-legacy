 ...
 * {@link Rochade} which is the only move that moves two pieces. Essentially a
 * move represents a data transfer object (DTO) and must be validated before
 * creation. Therefore each move class should offer validation method which is
 * checked before creation and objects should only be created by factory
 * methods.
 */
